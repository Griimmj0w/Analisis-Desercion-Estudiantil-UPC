...
prec_orig, rec_orig, f1_orig, _ = precision_recall_fscore_support(y_test, pred, average="binary")
print(f"{best_name} | AUC={auc:.3f} | Precision={prec_orig:.3f} | Recall={rec_orig:.3f} | F1={f1_orig:.3f}")
...
print(f"RF BASE  | AUC={auc:.3f} Precision={prec_orig:.3f} Recall={rec_orig:.3f} F1={f1_orig:.3f}")
print(f"RF CALIB | AUC={auc_cal:.3f} Precision={Pcal:.3f} Recall={Rcal:.3f} F1={F1cal:.3f}")
...
print("✓ modelo_desercion.pkl - Modelo entrenado")
print("✓ benchmark_modelos.csv - Comparación de modelos")
print("✓ resumen_variables.csv - Análisis de variables")
print("✓ curva_precision_recall.png - Curva PR con umbrales")
print("✓ matriz_confusion_umbral_optimo.png - Matriz confusión (umbral óptimo)")
